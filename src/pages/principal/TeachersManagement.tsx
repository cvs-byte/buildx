  ...
  return (
    <div className="ag-page-container">
      <div className="ag-page-header">
        <div>
          <h1 className="ag-page-title">Faculty & Teachers Management</h1>
          <p className="ag-page-subtitle">
            Principal scope: Recruit and manage teaching faculty for {currentUser?.schoolName || schoolId || 'your school'}.
          </p>
        </div>
        <Button
      ...
      <Table
        ...
        isLoading={isLoading}
        emptyMessage="No faculty teachers found in database for this school."
      />
      ...
      <Modal
        ...
        subtitle="Recruit a teacher and assign department specialization within your school."
      >
        <CreateUserForm
          initialRole="TEACHER"
